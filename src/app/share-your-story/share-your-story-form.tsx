  ...
  return (
    <form action={action} className="space-y-10">
      ...
      state.outcome?.code === "DUPLICATE_ACCEPTED" ? (
        <section
          aria-live="polite"
          className="border-brand-traditional-green bg-surface-subtle border-l-4 p-6"
        >
          <h2 className="text-brand-black type-display text-3xl">Thank you.</h2>
      ...
      <aside
        className="border-border bg-surface-subtle border-y px-5 py-6"
        aria-labelledby="privacy-summary-heading"
      >
        <h2
          id="privacy-summary-heading"
          className="text-brand-black type-display text-2xl"
        >
      ...
      <fieldset className="border-border space-y-4 border-t pt-7">
        <legend className="text-brand-black type-display text-2xl">
          Before you send it
        </legend>
      ...
      <section aria-labelledby="image-heading" className="space-y-6">
        <div>
          ...
          >
            Images{" "}
            <span className="text-muted-foreground type-text text-base font-normal">
              (optional)
            </span>
          </h2>
