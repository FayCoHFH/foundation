    ...
    >
      <div className="mx-auto max-w-3xl px-5 sm:px-8">
        ...
        <h2
          ...
          className="type-display mt-4 max-w-xl text-4xl leading-tight font-semibold"
        >
          Every good neighbor brings something different.
        </h2>
        <p className="text-brand-white mt-5 max-w-2xl text-lg leading-8">
        ...
        <div className="mt-8 flex flex-wrap gap-x-6 gap-y-3 text-sm font-bold">
          <a
            className="text-brand-white decoration-brand-bright-green underline decoration-2 underline-offset-4"
            href={`mailto:?subject=${subject}`}
          >
            Share this Story
          </a>
          <Link
            className="text-brand-white decoration-brand-orange underline decoration-2 underline-offset-4"
            href="/"
          >
            Return home
          </Link>
