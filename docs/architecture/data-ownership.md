...
| Habitat Campaign narrative, public status, timing, editorial facts, and display goal/progress | Habitat platform | Typed Campaign root, immutable revisions/snapshots, bounded public projection, ordered facts, and revision-scoped Campaign–Project references | C1 owns only public editorial initiative facts; goal/progress is integer-cent USD display content, not accounting, donor, payment, or DonorView truth. Giving integration is a later boundary |
