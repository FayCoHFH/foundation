...
| Public media provenance, credits, rights/consent, and contextual alt text/captions | Habitat platform | MediaAsset source metadata plus relationship/snapshot-specific presentation text; confidential Story Submission image declarations, subjects, clearances, restrictions, and revocation requests remain in the intake boundary until controlled promotion | Local publication rules govern eligibility; one asset may require different alternatives in different contexts |
